...
# design shape env
export CUDA_EXEC_PARAM_GIST_B=1536 CUDA_EXEC_PARAM_GIST_F=1491 \
       CUDA_EXEC_PARAM_GIST_D=192 CUDA_EXEC_PARAM_GIST_Q=128
# harness buffer sizing (B*F*D, F*Q*F, B*Q*D -> max; out=B*Q*D) — MUST match driver.py config
...
export CUDA_EXEC_PARAM_HARNESS_NUM_INPUTS=4
export CUDA_EXEC_PARAM_HARNESS_NUM_OUTPUTS=1
export CUDA_EXEC_PARAM_HARNESS_BUF_SIZE=439713792
...
export CUDA_EXEC_PARAM_HARNESS_SCALE_2=0.08971226080325134
export CUDA_EXEC_PARAM_HARNESS_SCALE_3=0.0023233411234995
